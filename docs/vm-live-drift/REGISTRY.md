...
| DRIFT-001 | [cve-patches-libxml2-curl-apache-200.5.8](./DRIFT-001-cve-patches-libxml2-curl-apache-200.5.8.md) | Partner Center 2026-07-15 (rapport AMAT 200.5.8) | `standard/6.0.20260609` | OS Ubuntu (apt — libxml2, curl/libcurl*, apache2*) | `open` | **`code-fixed`** (gates à ajouter dans `01`/`03`, rebuild + submission) | `packer/provisioners/01-install-base.sh` §2.b + `packer/provisioners/03-install-apache.sh` §1.b | [ADR-300](../adr/300-SEC-securite-hardening-vm-certification.md), [ADR-619](../adr/619-DEVOPS-registre-drift-vm-live-vs-packer.md), [ADR-804](../adr/804-BIZ-politiques-certification-microsoft-marketplace.md) | `packer/scripts/integration-test.sh image` — `T-CERT-08a..08h` | [#4](https://github.com/michel-heon/semantic-media-wiki-marketplace/issues/4) |
